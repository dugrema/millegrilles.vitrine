...
docker run --rm -it \
      ...
      --env LISTE_MILLEGRILLES='IDMG=bKKwtXC68HR4:WEB_URL=mg-dev3.maple.maceroc.com:WEB_CERT=/certs/bKKwtXC68HR4.pki.vitrine.fullchain.20200106a:WEB_KEY=/certs/bKKwtXC68HR4.pki.vitrine.key.20200106a' \
